...
searchForm.addEventListener("submit", (e) => {
  ...
  document.querySelector('.search-heading').classList.add('active');

  //Add Searched city to left container
    const searchedCity=document.createElement('div');
    searchedCity.innerHTML=searchInp.value;
    searchedCity.classList.add('left-items');
    document.querySelector('.searches').appendChild(searchedCity);
...
addEventListener('click',function(details){
    var city=details.target.innerText;
    // console.log(city);
...
document.getElementById('madhur').addEventListener('click',()=>{
    window.location.href='https://www.instagram.com/madhur_kannamwar';
})
